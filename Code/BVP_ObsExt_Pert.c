...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	...
	for (i = 0; i < m-1; ++i)
  {
	...
	{
		{
			...
			gtt0  =	-KERRfISOout (rhoT,yk,r_H,M);
			gtph0 =	-KERRlISOout (rhoT,yk,r_H,M)*KERRomegaISOout (rhoT,yk,r_H,M)/KERRfISOout (rhoT,yk,r_H,M)*rhoT*pow(sin(yk),2.0);
			gpsi =	u4d00k;

			gtt2 = -u0d00k;
			gtph2 = rhoT*pow(sin(yk),2.0)*(-KERRlISOout (rhoT,yk,r_H,M)/KERRfISOout (rhoT,yk,r_H,M)*u3d00k - KERRomegaISOout (rhoT,yk,r_H,M)/KERRfISOout (rhoT,yk,r_H,M)*u2d00k + KERRlISOout (rhoT,yk,r_H,M)*KERRomegaISOout (rhoT,yk,r_H,M)/pow(KERRfISOout (rhoT,yk,r_H,M),2.0)*u0d00k);

			gtt = gtt0 + gtt2;
			gtph = gtph0 + gtph2;

			printf("f2 = %11.4e. m2 = %11.4e. l2 = %11.4e. omega2 = %11.4e. psi2 = %11.4e.\n",u0d00k, u1d00k,u2d00k,u3d00k,u4d00k);
			printf("gtt0 = %11.4e. gtph0 = %11.4e. gpsi = %11.4e.\n",gtt0,gtph0,gpsi);
			printf("gtt2 = %11.4e. gtph2 = %11.4e.\n",gtt2,gtph2);
			printf("gtt  = %11.4e. gtph  = %11.4e.\n",gtt,gtph);
			...
			//printf("With an error of O(r_H/rho) = %11.4e:\n",r_H/rhoT);
	...
	{
		{
			...
			printf("a   = %14.7e.\n",ainf);
			printf("chi = %14.7e <= 1.\n",chiinf);
			printf("M0 using ^ = %14.7e.\n",2*r_H/sqrt(1.0-pow(chiinf,2.0)));
			M0 = 2.0*r_H/sqrt(1.0-pow(chiinf,2.0));
			printf("correction with this = %14.7e.\n",Minf/(2*r_H/sqrt(1.0-pow(chiinf,2.0)))-1.0);
		...
		{
			{
				...
				FLR = FLRout(xk,yk,r_H,M,alpha,beta, KERRu0Xout (xk,yk,r_H,M)+u0d00k, KERRdu0dxXout (xk,yk,r_H,M)+u0d10k, KERRd2u0dx2Xout (xk,yk,r_H,M)+u0d20k, KERRu1Xout (xk,yk,r_H,M)+u1d00k, KERRdu1dxXout (xk,yk,r_H,M)+u1d10k, KERRd2u1dx2Xout (xk,yk,r_H,M)+u1d20k, KERRu2Xout (xk,yk,r_H,M)+u2d00k, KERRdu2dxXout (xk,yk,r_H,M)+u2d10k, KERRd2u2dx2Xout (xk,yk,r_H,M)+u2d20k, KERRu3Xout (xk,yk,r_H,M)+u3d00k, KERRdu3dxXout (xk,yk,r_H,M)+u3d10k, KERRd2u3dx2Xout (xk,yk,r_H,M)+u3d20k, KERRu4Xout (xk,yk,r_H,M)+u4d00k, KERRdu4dxXout (xk,yk,r_H,M)+u4d10k, KERRd2u4dx2Xout (xk,yk,r_H,M)+u4d20k);
				dFLRdx = dFLRdxout(xk,yk,r_H,M,alpha,beta, KERRu0Xout (xk,yk,r_H,M)+u0d00k, KERRdu0dxXout (xk,yk,r_H,M)+u0d10k, KERRd2u0dx2Xout (xk,yk,r_H,M)+u0d20k, KERRu1Xout (xk,yk,r_H,M)+u1d00k, KERRdu1dxXout (xk,yk,r_H,M)+u1d10k, KERRd2u1dx2Xout (xk,yk,r_H,M)+u1d20k, KERRu2Xout (xk,yk,r_H,M)+u2d00k, KERRdu2dxXout (xk,yk,r_H,M)+u2d10k, KERRd2u2dx2Xout (xk,yk,r_H,M)+u2d20k, KERRu3Xout (xk,yk,r_H,M)+u3d00k, KERRdu3dxXout (xk,yk,r_H,M)+u3d10k, KERRd2u3dx2Xout (xk,yk,r_H,M)+u3d20k, KERRu4Xout (xk,yk,r_H,M)+u4d00k, KERRdu4dxXout (xk,yk,r_H,M)+u4d10k, KERRd2u4dx2Xout (xk,yk,r_H,M)+u4d20k);
				...
				xk = xLR;
				++l;
				printf("FLR = %e. dFLRdx = %e. xLR = %.3f. xk = %.3f.\n",FLR, dFLRdx,xLR,xk);

			}
		}

	} while(fabs(FLR) > pow(tol,2.0));
	OmegaLR = OrbLRout(xk,yk,r_H,M,alpha,beta, KERRu0Xout (xk,yk,r_H,M)+u0d00k, KERRdu0dxXout (xk,yk,r_H,M)+u0d10k, KERRd2u0dx2Xout (xk,yk,r_H,M)+u0d20k, KERRu1Xout (xk,yk,r_H,M)+u1d00k, KERRdu1dxXout (xk,yk,r_H,M)+u1d10k, KERRd2u1dx2Xout (xk,yk,r_H,M)+u1d20k, KERRu2Xout (xk,yk,r_H,M)+u2d00k, KERRdu2dxXout (xk,yk,r_H,M)+u2d10k, KERRd2u2dx2Xout (xk,yk,r_H,M)+u2d20k, KERRu3Xout (xk,yk,r_H,M)+u3d00k, KERRdu3dxXout (xk,yk,r_H,M)+u3d10k, KERRd2u3dx2Xout (xk,yk,r_H,M)+u3d20k, KERRu4Xout (xk,yk,r_H,M)+u4d00k, KERRdu4dxXout (xk,yk,r_H,M)+u4d10k, KERRd2u4dx2Xout (xk,yk,r_H,M)+u4d20k);
	...
	*/
		...
		{
			{
				...
				FISCO = FISCOout(xk,yk,r_H,M,alpha,beta, KERRu0Xout (xk,yk,r_H,M)+u0d00k, KERRdu0dxXout (xk,yk,r_H,M)+u0d10k, KERRd2u0dx2Xout (xk,yk,r_H,M)+u0d20k, KERRu1Xout (xk,yk,r_H,M)+u1d00k, KERRdu1dxXout (xk,yk,r_H,M)+u1d10k, KERRd2u1dx2Xout (xk,yk,r_H,M)+u1d20k, KERRu2Xout (xk,yk,r_H,M)+u2d00k, KERRdu2dxXout (xk,yk,r_H,M)+u2d10k, KERRd2u2dx2Xout (xk,yk,r_H,M)+u2d20k, KERRu3Xout (xk,yk,r_H,M)+u3d00k, KERRdu3dxXout (xk,yk,r_H,M)+u3d10k, KERRd2u3dx2Xout (xk,yk,r_H,M)+u3d20k, KERRu4Xout (xk,yk,r_H,M)+u4d00k, KERRdu4dxXout (xk,yk,r_H,M)+u4d10k, KERRd2u4dx2Xout (xk,yk,r_H,M)+u4d20k);
				FISCOdx = FISCOout(xk+deltax,yk,r_H,M,alpha,beta, KERRu0Xout (xk,yk,r_H,M)+u0d00k, KERRdu0dxXout (xk,yk,r_H,M)+u0d10k, KERRd2u0dx2Xout (xk,yk,r_H,M)+u0d20k, KERRu1Xout (xk,yk,r_H,M)+u1d00k, KERRdu1dxXout (xk,yk,r_H,M)+u1d10k, KERRd2u1dx2Xout (xk,yk,r_H,M)+u1d20k, KERRu2Xout (xk,yk,r_H,M)+u2d00k, KERRdu2dxXout (xk,yk,r_H,M)+u2d10k, KERRd2u2dx2Xout (xk,yk,r_H,M)+u2d20k, KERRu3Xout (xk,yk,r_H,M)+u3d00k, KERRdu3dxXout (xk,yk,r_H,M)+u3d10k, KERRd2u3dx2Xout (xk,yk,r_H,M)+u3d20k, KERRu4Xout (xk,yk,r_H,M)+u4d00k, KERRdu4dxXout (xk,yk,r_H,M)+u4d10k, KERRd2u4dx2Xout (xk,yk,r_H,M)+u4d20k);
				...
				printf("FISCO = %e. dFISCOdx = %e. xLR = %.3f. xk = %.3f.\n",FISCO, dFISCOdx,xISCO,xk);
				xk = xISCO;
				++l;
	...
	OmegaISCO = OrbISCOout(xk,yk,r_H,M,alpha,beta, KERRu0Xout (xk,yk,r_H,M)+u0d00k, KERRdu0dxXout (xk,yk,r_H,M)+u0d10k, KERRd2u0dx2Xout (xk,yk,r_H,M)+u0d20k, KERRu1Xout (xk,yk,r_H,M)+u1d00k, KERRdu1dxXout (xk,yk,r_H,M)+u1d10k, KERRd2u1dx2Xout (xk,yk,r_H,M)+u1d20k, KERRu2Xout (xk,yk,r_H,M)+u2d00k, KERRdu2dxXout (xk,yk,r_H,M)+u2d10k, KERRd2u2dx2Xout (xk,yk,r_H,M)+u2d20k, KERRu3Xout (xk,yk,r_H,M)+u3d00k, KERRdu3dxXout (xk,yk,r_H,M)+u3d10k, KERRd2u3dx2Xout (xk,yk,r_H,M)+u3d20k, KERRu4Xout (xk,yk,r_H,M)+u4d00k, KERRdu4dxXout (xk,yk,r_H,M)+u4d10k, KERRd2u4dx2Xout (xk,yk,r_H,M)+u4d20k);
...
/*
	...
	for (j = 0; j < n; ++j)
	{
		...
		for (i = 0; i < Iyplot; ++i)
		{
			yk = y[yplot[i]];
			k = (yplot[i]*n+j)*p;
			fprintf(pkoutfile," %22.15e %22.15e %22.15e %22.15e %22.15e", Psi[k +0],
			Psi[k +1],
			Psi[k +2],
			Psi[k +3],
			Psi[k +4]);
...
/*
	...
	sprintf(poutname,"./Data/PlotData/KERRfromSCHW_angleplotdata_chi%03i_n%03i_m%02i.dat", (int) round(chi*1.0E2), n, m);
...
// - pow(xk,2.0)*IC0out(xk,yk,r_H,2.0*r_H,0.0,1.0,0.0)
		for (i = 0; i < 3; ++i)
		{
			yk = y[yplot[i]];
			k = (yplot[i]*n+j)*p;
			fprintf(poutfile," %22.15e %22.15e %22.15e %22.15e %22.15e", Psi[k +0] - pow(xk,2.0)*IC0out(xk,yk,r_H,2.0*r_H,0.0,1.0,0.0),
			Psi[k +1] - pow(xk,2.0)*IC1out(xk,yk,r_H,2.0*r_H,0.0,1.0,0.0),
			Psi[k +2] - pow(xk,2.0)*IC2out(xk,yk,r_H,2.0*r_H,0.0,1.0,0.0),
			Psi[k +3] - pow(xk,2.0)*IC3out(xk,yk,r_H,2.0*r_H,0.0,1.0,0.0),
			Psi[k +4] - pow(xk,2.0)*IC4out(xk,yk,r_H,2.0*r_H,0.0,1.0,0.0));
		}
		fprintf(poutfile,"\n");
	}
	fclose(poutfile);
